// Auto-generated by combine.js — do not edit manually.
// Last built: 2026-06-14T18:32:51.081Z
// 3 course(s) · 559 lessons · 173 glossary terms

const COURSES = [
  {
    "slug": "ai-engineering",
    "title": "AI Engineering from Scratch",
    "tagline": "468 lessons. 20 phases. Every algorithm built from raw math before a single framework gets imported.",
    "description": "Build the math, the model, the trainer, the tokenizer, and the agent loop. Once, by hand.",
    "githubRepo": "Linzo99/anything-from-scratch",
    "githubBranch": "main",
    "contentHost": "local",
    "phases": [
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/00-setup-and-tooling/01-dev-environment"
          },
          {
            ...
            "path": "phases/ai-engineering/00-setup-and-tooling/02-git-and-collaboration"
          },
          {
            ...
            "path": "phases/ai-engineering/00-setup-and-tooling/03-gpu-setup-and-cloud"
          },
          {
            "name": "APIs & Keys",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/00-setup-and-tooling/04-apis-and-keys"
          },
          {
            ...
            "path": "phases/ai-engineering/00-setup-and-tooling/05-jupyter-notebooks"
          },
          {
            ...
            "path": "phases/ai-engineering/00-setup-and-tooling/06-python-environments"
          },
          {
            "name": "Docker for AI",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/00-setup-and-tooling/07-docker-for-ai"
          },
          {
            "name": "Editor Setup",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/00-setup-and-tooling/08-editor-setup"
          },
          {
            ...
            "path": "phases/ai-engineering/00-setup-and-tooling/09-data-management"
          },
          {
            "name": "Terminal & Shell",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/00-setup-and-tooling/10-terminal-and-shell"
          },
          {
            "name": "Linux for AI",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/00-setup-and-tooling/11-linux-for-ai"
          },
          {
            ...
            "path": "phases/ai-engineering/00-setup-and-tooling/12-debugging-and-profiling"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/01-linear-algebra-intuition"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/02-vectors-matrices-operations"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/03-matrix-transformations"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/04-calculus-for-ml"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/05-chain-rule-and-autodiff"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/06-probability-and-distributions"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/07-bayes-theorem"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/08-optimization"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/09-information-theory"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/10-dimensionality-reduction"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/11-singular-value-decomposition"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/12-tensor-operations"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/13-numerical-stability"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/14-norms-and-distances"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/15-statistics-for-ml"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/16-sampling-methods"
          },
          {
            "name": "Linear Systems",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/01-math-foundations/17-linear-systems"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/18-convex-optimization"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/19-complex-numbers"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/20-fourier-transform"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/21-graph-theory"
          },
          {
            ...
            "path": "phases/ai-engineering/01-math-foundations/22-stochastic-processes"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/01-what-is-machine-learning"
          },
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/02-linear-regression"
          },
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/03-logistic-regression"
          },
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/04-decision-trees"
          },
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/05-support-vector-machines"
          },
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/06-knn-and-distances"
          },
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/07-unsupervised-learning"
          },
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/08-feature-engineering"
          },
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/09-model-evaluation"
          },
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/10-bias-variance"
          },
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/11-ensemble-methods"
          },
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/12-hyperparameter-tuning"
          },
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/13-ml-pipelines"
          },
          {
            "name": "Naive Bayes",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/14-naive-bayes"
          },
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/15-time-series"
          },
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/16-anomaly-detection"
          },
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/17-imbalanced-data"
          },
          {
            ...
            "path": "phases/ai-engineering/02-ml-fundamentals/18-feature-selection"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/03-deep-learning-core/01-the-perceptron"
          },
          {
            ...
            "path": "phases/ai-engineering/03-deep-learning-core/02-multi-layer-networks"
          },
          {
            ...
            "path": "phases/ai-engineering/03-deep-learning-core/03-backpropagation"
          },
          {
            ...
            "path": "phases/ai-engineering/03-deep-learning-core/04-activation-functions"
          },
          {
            ...
            "path": "phases/ai-engineering/03-deep-learning-core/05-loss-functions"
          },
          {
            ...
            "path": "phases/ai-engineering/03-deep-learning-core/06-optimizers"
          },
          {
            ...
            "path": "phases/ai-engineering/03-deep-learning-core/07-regularization"
          },
          {
            ...
            "path": "phases/ai-engineering/03-deep-learning-core/08-weight-initialization"
          },
          {
            ...
            "path": "phases/ai-engineering/03-deep-learning-core/09-learning-rate-schedules"
          },
          {
            ...
            "path": "phases/ai-engineering/03-deep-learning-core/10-mini-framework"
          },
          {
            ...
            "path": "phases/ai-engineering/03-deep-learning-core/11-intro-to-pytorch"
          },
          {
            ...
            "path": "phases/ai-engineering/03-deep-learning-core/12-intro-to-jax"
          },
          {
            ...
            "path": "phases/ai-engineering/03-deep-learning-core/13-debugging-neural-networks"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/01-image-fundamentals"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/02-convolutions-from-scratch"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/03-cnns-lenet-to-resnet"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/04-image-classification"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/05-transfer-learning"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/06-object-detection-yolo"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/07-semantic-segmentation-unet"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/08-instance-segmentation-mask-rcnn"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/09-image-generation-gans"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/10-image-generation-diffusion"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/11-stable-diffusion"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/12-video-understanding"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/13-3d-vision-nerf"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/14-vision-transformers"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/15-real-time-edge"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/16-vision-pipeline-capstone"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/17-self-supervised-vision"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/18-open-vocab-clip"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/19-ocr-document-understanding"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/20-image-retrieval-metric"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/21-keypoint-pose"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/22-3d-gaussian-splatting"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/23-diffusion-transformers-rectified-flow"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/24-sam3-open-vocab-segmentation"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/25-vision-language-models"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/26-monocular-depth"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/27-multi-object-tracking"
          },
          {
            ...
            "path": "phases/ai-engineering/04-computer-vision/28-world-models-video-diffusion"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/01-text-processing"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/02-bag-of-words-tfidf"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/03-word-embeddings-word2vec"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/04-glove-fasttext-subword"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/05-sentiment-analysis"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/06-named-entity-recognition"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/07-pos-tagging-parsing"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/08-cnns-rnns-for-text"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/09-sequence-to-sequence"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/10-attention-mechanism"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/11-machine-translation"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/12-text-summarization"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/13-question-answering"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/14-information-retrieval-search"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/15-topic-modeling"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/16-text-generation-pre-transformer"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/17-chatbots-rule-to-neural"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/18-multilingual-nlp"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/19-subword-tokenization"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/20-structured-outputs-constrained-decoding"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/21-nli-textual-entailment"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/22-embedding-models-deep-dive"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/23-chunking-strategies-rag"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/24-coreference-resolution"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/25-entity-linking"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/26-relation-extraction-kg"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/27-llm-evaluation-frameworks"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/28-long-context-evaluation"
          },
          {
            ...
            "path": "phases/ai-engineering/05-nlp-foundations-to-advanced/29-dialogue-state-tracking"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/01-audio-fundamentals"
          },
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/02-spectrograms-mel-features"
          },
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/03-audio-classification"
          },
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/04-speech-recognition-asr"
          },
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/05-whisper-architecture-finetuning"
          },
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/06-speaker-recognition-verification"
          },
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/07-text-to-speech"
          },
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/08-voice-cloning-conversion"
          },
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/09-music-generation"
          },
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/10-audio-language-models"
          },
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/11-real-time-audio-processing"
          },
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/12-voice-assistant-pipeline"
          },
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/13-neural-audio-codecs"
          },
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/14-voice-activity-detection-turn-taking"
          },
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/15-streaming-speech-to-speech-moshi-hibiki"
          },
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/16-anti-spoofing-audio-watermarking"
          },
          {
            ...
            "path": "phases/ai-engineering/06-speech-and-audio/17-audio-evaluation-metrics"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/07-transformers-deep-dive/01-why-transformers"
          },
          {
            ...
            "path": "phases/ai-engineering/07-transformers-deep-dive/02-self-attention-from-scratch"
          },
          {
            ...
            "path": "phases/ai-engineering/07-transformers-deep-dive/03-multi-head-attention"
          },
          {
            ...
            "path": "phases/ai-engineering/07-transformers-deep-dive/04-positional-encoding"
          },
          {
            ...
            "path": "phases/ai-engineering/07-transformers-deep-dive/05-full-transformer"
          },
          {
            ...
            "path": "phases/ai-engineering/07-transformers-deep-dive/06-bert-masked-language-modeling"
          },
          {
            ...
            "path": "phases/ai-engineering/07-transformers-deep-dive/07-gpt-causal-language-modeling"
          },
          {
            ...
            "path": "phases/ai-engineering/07-transformers-deep-dive/08-t5-bart-encoder-decoder"
          },
          {
            "name": "Vision Transformers (ViT)",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/07-transformers-deep-dive/09-vision-transformers"
          },
          {
            ...
            "path": "phases/ai-engineering/07-transformers-deep-dive/10-audio-transformers-whisper"
          },
          {
            ...
            "path": "phases/ai-engineering/07-transformers-deep-dive/11-mixture-of-experts"
          },
          {
            ...
            "path": "phases/ai-engineering/07-transformers-deep-dive/12-kv-cache-flash-attention"
          },
          {
            "name": "Scaling Laws",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/07-transformers-deep-dive/13-scaling-laws"
          },
          {
            ...
            "path": "phases/ai-engineering/07-transformers-deep-dive/14-build-a-transformer-capstone"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/08-generative-ai/01-generative-models-taxonomy-history"
          },
          {
            ...
            "path": "phases/ai-engineering/08-generative-ai/02-autoencoders-vae"
          },
          {
            ...
            "path": "phases/ai-engineering/08-generative-ai/03-gans-generator-discriminator"
          },
          {
            ...
            "path": "phases/ai-engineering/08-generative-ai/04-conditional-gans-pix2pix"
          },
          {
            "name": "StyleGAN",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/08-generative-ai/05-stylegan"
          },
          {
            ...
            "path": "phases/ai-engineering/08-generative-ai/06-diffusion-ddpm-from-scratch"
          },
          {
            ...
            "path": "phases/ai-engineering/08-generative-ai/07-latent-diffusion-stable-diffusion"
          },
          {
            ...
            "path": "phases/ai-engineering/08-generative-ai/08-controlnet-lora-conditioning"
          },
          {
            ...
            "path": "phases/ai-engineering/08-generative-ai/09-inpainting-outpainting-editing"
          },
          {
            ...
            "path": "phases/ai-engineering/08-generative-ai/10-video-generation"
          },
          {
            ...
            "path": "phases/ai-engineering/08-generative-ai/11-audio-generation"
          },
          {
            "name": "3D Generation",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/08-generative-ai/12-3d-generation"
          },
          {
            ...
            "path": "phases/ai-engineering/08-generative-ai/13-flow-matching-rectified-flows"
          },
          {
            ...
            "path": "phases/ai-engineering/08-generative-ai/14-evaluation-fid-clip-score"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/09-reinforcement-learning/01-mdps-states-actions-rewards"
          },
          {
            ...
            "path": "phases/ai-engineering/09-reinforcement-learning/02-dynamic-programming"
          },
          {
            ...
            "path": "phases/ai-engineering/09-reinforcement-learning/03-monte-carlo-methods"
          },
          {
            ...
            "path": "phases/ai-engineering/09-reinforcement-learning/04-q-learning-sarsa"
          },
          {
            ...
            "path": "phases/ai-engineering/09-reinforcement-learning/05-dqn"
          },
          {
            ...
            "path": "phases/ai-engineering/09-reinforcement-learning/06-policy-gradients-reinforce"
          },
          {
            ...
            "path": "phases/ai-engineering/09-reinforcement-learning/07-actor-critic-a2c-a3c"
          },
          {
            "name": "PPO",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/09-reinforcement-learning/08-ppo"
          },
          {
            ...
            "path": "phases/ai-engineering/09-reinforcement-learning/09-reward-modeling-rlhf"
          },
          {
            "name": "Multi-Agent RL",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/09-reinforcement-learning/10-multi-agent-rl"
          },
          {
            ...
            "path": "phases/ai-engineering/09-reinforcement-learning/11-sim-to-real-transfer"
          },
          {
            "name": "RL for Games",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/09-reinforcement-learning/12-rl-for-games"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/01-tokenizers"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/02-building-a-tokenizer"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/03-data-pipelines"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/04-pre-training-mini-gpt"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/05-scaling-distributed"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/06-instruction-tuning-sft"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/07-rlhf"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/08-dpo"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/09-constitutional-ai-self-improvement"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/10-evaluation"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/11-quantization"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/12-inference-optimization"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/13-building-complete-llm-pipeline"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/14-open-models-architecture-walkthroughs"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/15-speculative-decoding-eagle3"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/16-differential-attention-v2"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/17-native-sparse-attention"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/18-multi-token-prediction"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/19-dualpipe-parallelism"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/20-deepseek-v3-walkthrough"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/21-jamba-hybrid-ssm-transformer"
          },
          {
            ...
            "path": "phases/ai-engineering/10-llms-from-scratch/22-async-hogwild-inference"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/01-prompt-engineering"
          },
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/02-few-shot-cot"
          },
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/03-structured-outputs"
          },
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/04-embeddings"
          },
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/05-context-engineering"
          },
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/06-rag"
          },
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/07-advanced-rag"
          },
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/08-fine-tuning-lora"
          },
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/09-function-calling"
          },
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/10-evaluation"
          },
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/11-caching-cost"
          },
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/12-guardrails"
          },
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/13-production-app"
          },
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/14-model-context-protocol"
          },
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/15-prompt-caching"
          },
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/16-langgraph-state-machines"
          },
          {
            ...
            "path": "phases/ai-engineering/11-llm-engineering/17-agent-framework-tradeoffs"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/01-vision-transformer-patch-tokens"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/02-clip-contrastive-pretraining"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/03-blip2-qformer-bridge"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/04-flamingo-gated-cross-attention"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/05-llava-visual-instruction-tuning"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/06-any-resolution-patch-n-pack"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/07-open-weight-vlm-recipes"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/08-llava-onevision-single-multi-video"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/09-qwen-vl-family-dynamic-fps"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/10-internvl3-native-multimodal"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/11-chameleon-early-fusion-tokens"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/12-emu3-next-token-for-generation"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/13-transfusion-autoregressive-diffusion"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/14-show-o-discrete-diffusion-unified"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/15-janus-pro-decoupled-encoders"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/16-mio-any-to-any-streaming"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/17-video-language-temporal-grounding"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/18-long-video-million-token"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/19-audio-language-whisper-to-af3"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/20-omni-models-thinker-talker"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/21-embodied-vlas-openvla-pi0-groot"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/22-document-diagram-understanding"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/23-colpali-vision-native-rag"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/24-multimodal-rag-cross-modal"
          },
          {
            ...
            "path": "phases/ai-engineering/12-multimodal-ai/25-multimodal-agents-computer-use"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/01-the-tool-interface"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/02-function-calling-deep-dive"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/03-parallel-and-streaming-tool-calls"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/04-structured-output"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/05-tool-schema-design"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/06-mcp-fundamentals"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/07-building-an-mcp-server"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/08-building-an-mcp-client"
          },
          {
            "name": "MCP Transports",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/09-mcp-transports"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/10-mcp-resources-and-prompts"
          },
          {
            "name": "MCP Sampling",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/11-mcp-sampling"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/12-mcp-roots-and-elicitation"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/13-mcp-async-tasks"
          },
          {
            "name": "MCP Apps",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/14-mcp-apps"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/15-mcp-security-tool-poisoning"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/16-mcp-security-oauth-2-1"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/17-mcp-gateways-and-registries"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/18-mcp-auth-production"
          },
          {
            "name": "A2A Protocol",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/19-a2a-protocol"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/20-opentelemetry-genai"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/21-llm-routing-layer"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/22-skills-and-agent-sdks"
          },
          {
            ...
            "path": "phases/ai-engineering/13-tools-and-protocols/23-capstone-tool-ecosystem"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/01-the-agent-loop"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/02-rewoo-plan-and-execute"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/03-reflexion-verbal-rl"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/04-tree-of-thoughts-lats"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/05-self-refine-and-critic"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/06-tool-use-and-function-calling"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/07-memory-virtual-context-memgpt"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/08-memory-blocks-sleep-time-compute"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/09-hybrid-memory-mem0"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/10-skill-libraries-voyager"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/11-planning-htn-and-evolutionary"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/12-anthropic-workflow-patterns"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/13-langgraph-stateful-graphs"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/14-autogen-actor-model"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/15-crewai-role-based-crews"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/16-openai-agents-sdk"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/17-claude-agent-sdk"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/18-agno-and-mastra-runtimes"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/19-benchmarks-swebench-gaia"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/20-benchmarks-webarena-osworld"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/21-computer-use-agents"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/22-voice-agents-pipecat-livekit"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/23-otel-genai-conventions"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/24-agent-observability-platforms"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/25-multi-agent-debate"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/26-failure-modes-agentic"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/27-prompt-injection-defense"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/28-orchestration-patterns"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/29-production-runtimes"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/30-eval-driven-agent-development"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/31-agent-workbench-why-models-fail"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/32-minimal-agent-workbench"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/33-instructions-as-executable-constraints"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/34-repo-memory-and-state"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/35-initialization-scripts"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/36-scope-contracts"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/37-runtime-feedback-loops"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/38-verification-gates"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/39-reviewer-agent"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/40-multi-session-handoff"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/41-workbench-for-real-repos"
          },
          {
            ...
            "path": "phases/ai-engineering/14-agent-engineering/42-agent-workbench-capstone"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/01-long-horizon-agents"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/02-star-family-reasoning"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/03-alphaevolve-evolutionary-coding"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/04-darwin-godel-machine"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/05-ai-scientist-v2"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/06-automated-alignment-research"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/07-recursive-self-improvement"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/08-bounded-self-improvement"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/09-coding-agent-landscape"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/10-claude-code-permission-modes"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/11-browser-agents"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/12-durable-execution"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/13-cost-governors"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/14-kill-switches-canaries"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/15-propose-then-commit"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/16-checkpoints-rollback"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/17-constitutional-ai"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/18-llama-guard"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/19-anthropic-rsp"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/20-openai-preparedness-deepmind-fsf"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/21-metr-external-evaluation"
          },
          {
            ...
            "path": "phases/ai-engineering/15-autonomous-systems/22-cais-caisi-societal-risk"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/01-why-multi-agent"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/02-fipa-acl-heritage"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/03-communication-protocols"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/04-primitive-model"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/05-supervisor-orchestrator-pattern"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/06-hierarchical-architecture"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/07-society-of-mind-debate"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/08-role-specialization"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/09-parallel-swarm-networks"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/10-group-chat-speaker-selection"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/11-handoffs-and-routines"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/12-a2a-protocol"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/13-shared-memory-blackboard"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/14-consensus-and-bft"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/15-voting-debate-topology"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/16-negotiation-bargaining"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/17-generative-agents-simulation"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/18-theory-of-mind-coordination"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/19-swarm-optimization-pso-aco"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/20-marl-maddpg-qmix-mappo"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/21-agent-economies"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/22-production-scaling-queues-checkpoints"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/23-failure-modes-mast-groupthink"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/24-evaluation-coordination-benchmarks"
          },
          {
            ...
            "path": "phases/ai-engineering/16-multi-agent-and-swarms/25-case-studies-2026-sota"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/01-managed-llm-platforms"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/02-inference-platform-economics"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/03-gpu-autoscaling-kubernetes"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/04-vllm-serving-internals"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/05-eagle3-speculative-decoding"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/06-sglang-radixattention"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/07-tensorrt-llm-blackwell"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/08-inference-metrics-goodput"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/09-production-quantization"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/10-cold-start-mitigation"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/11-multi-region-kv-locality"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/12-edge-inference"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/13-llm-observability"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/14-prompt-semantic-caching"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/15-batch-apis"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/16-model-routing"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/17-disaggregated-prefill-decode"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/18-vllm-production-stack-lmcache"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/19-ai-gateways"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/20-shadow-canary-progressive"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/21-ab-testing-llm-features"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/22-load-testing-llm-apis"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/23-sre-for-ai"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/24-chaos-engineering-llm"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/25-security-secrets-audit"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/26-compliance-frameworks"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/27-finops-llms"
          },
          {
            ...
            "path": "phases/ai-engineering/17-infrastructure-and-production/28-self-hosted-serving-selection"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/01-instruction-following-alignment-signal"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/02-reward-hacking-goodhart"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/03-direct-preference-optimization-family"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/04-sycophancy-rlhf-amplification"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/05-constitutional-ai-rlaif"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/06-mesa-optimization-deceptive-alignment"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/07-sleeper-agents-persistent-deception"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/08-in-context-scheming-frontier-models"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/09-alignment-faking"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/10-ai-control-subversion"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/11-scalable-oversight-weak-to-strong"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/12-red-teaming-pair-automated-attacks"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/13-many-shot-jailbreaking"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/14-ascii-art-visual-jailbreaks"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/15-indirect-prompt-injection"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/16-red-team-tooling-garak-llamaguard-pyrit"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/17-wmdp-dual-use-evaluation"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/18-frontier-safety-frameworks-rsp-pf-fsf"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/19-model-welfare-research"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/20-bias-representational-harm"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/21-fairness-criteria-group-individual-counterfactual"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/22-differential-privacy-for-llms"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/23-watermarking-synthid-stable-signature-c2pa"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/24-regulatory-frameworks-eu-us-uk-korea"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/25-echoleak-cves-for-ai"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/26-model-system-dataset-cards"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/27-data-provenance-training-governance"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/28-alignment-research-ecosystem"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/29-moderation-systems-openai-perspective-llamaguard"
          },
          {
            ...
            "path": "phases/ai-engineering/18-ethics-safety-alignment/30-dual-use-risk-cyber-bio-chem-nuclear"
          }
        ]
      },
      {
        ...
        "lessons": [
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/01-terminal-native-coding-agent"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/02-rag-over-codebase"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/03-realtime-voice-assistant"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/04-multimodal-document-qa"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/05-autonomous-research-agent"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/06-devops-troubleshooting-agent"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/07-end-to-end-fine-tuning-pipeline"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/08-production-rag-chatbot"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/09-code-migration-agent"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/10-multi-agent-software-team"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/11-llm-observability-dashboard"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/12-video-understanding-pipeline"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/13-mcp-server-with-registry"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/14-speculative-decoding-server"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/15-constitutional-safety-harness"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/16-github-issue-to-pr-agent"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/17-personal-ai-tutor"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/20-agent-harness-loop-contract"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/21-tool-registry-schema-validation"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/22-jsonrpc-stdio-transport"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/23-function-call-dispatcher"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/24-plan-execute-control-flow"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/25-verification-gates-observation-budget"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/26-sandbox-runner-denylist"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/27-eval-harness-fixture-tasks"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/28-observability-otel-traces"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/29-end-to-end-coding-task-demo"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/30-bpe-tokenizer-from-scratch"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/31-tokenized-dataset-sliding-window"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/32-token-positional-embeddings"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/33-multihead-self-attention"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/34-transformer-block"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/35-gpt-model-assembly"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/36-training-loop-eval"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/37-loading-pretrained-weights"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/38-classifier-finetuning"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/39-instruction-tuning-sft"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/40-dpo-from-scratch"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/41-eval-pipeline"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/42-large-corpus-downloader"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/43-hdf5-tokenized-corpus"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/44-cosine-lr-warmup"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/45-gradient-clipping-amp"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/46-gradient-accumulation"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/47-checkpoint-save-resume"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/48-distributed-fsdp-ddp"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/49-lm-eval-harness"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/50-hypothesis-generator"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/51-literature-retrieval"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/52-experiment-runner"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/53-result-evaluator"
          },
          {
            "name": "Paper Writer",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/19-capstone-projects/54-paper-writer"
          },
          {
            "name": "Critic Loop",
            "status": "complete",
            ...
            "path": "phases/ai-engineering/19-capstone-projects/55-critic-loop"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/56-iteration-scheduler"
          },
          {
            ...
            "path": "phases/ai-engineering/19-capstone-projects/57-end-to-end-research-demo"
          }
        ]
      }
    ],
  ...
  {
    "slug": "networking",
    "title": "Networking Basics from Scratch",
    "tagline": "52 lessons. 9 phases. From cables to protocols — build a working mental model of how the internet actually moves data.",
    "description": "A ground-up course on computer networking: how bits move across wires, how packets get routed across the globe, and how application-layer protocols like HTTP and DNS are built on top. You implement tools and write small servers at each phase so the abstractions stay concrete.",
    "githubRepo": "Linzo99/anything-from-scratch",
    "githubBranch": "main",
    "contentHost": "local",
    "phases": [
      {
        ...
        "name": "Foundations",
        "status": "complete",
        "desc": "Set up a Linux networking lab and build intuition for how data physically moves between machines.",
        "lessons": [
          {
            "name": "Set Up a Linux Networking Lab",
            "status": "complete",
            "type": "Build",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/00-foundations/01-lab-setup/",
            "path": "phases/networking/00-foundations/01-lab-setup",
            "summary": "Install Wireshark, netcat, nmap, and iproute2; verify they can capture live traffic on your loopback interface.",
            "keywords": "Wireshark · netcat · iproute2 · loopback"
          },
          {
            "name": "Capture Your First Packet",
            "status": "complete",
            "type": "Learn",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/00-foundations/02-first-packet/",
            "path": "phases/networking/00-foundations/02-first-packet",
            "summary": "Use tcpdump to capture a ping exchange and identify the Ethernet, IP, and ICMP layers in the hex dump.",
            "keywords": "tcpdump · ICMP · Ethernet frame · hex dump"
          },
          {
            "name": "Understand the OSI Model",
            "status": "complete",
            "type": "Learn",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/00-foundations/03-osi-model/",
            "path": "phases/networking/00-foundations/03-osi-model",
            "summary": "Map a real captured packet to each OSI layer and explain what job each layer does in one sentence.",
            "keywords": "OSI model · encapsulation · protocol stack"
          },
          {
            "name": "Compare OSI vs TCP/IP",
            "status": "complete",
            "type": "Learn",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/00-foundations/04-tcp-ip-model/",
            "path": "phases/networking/00-foundations/04-tcp-ip-model",
            "summary": "Draw the TCP/IP four-layer model and explain where real protocols (IP, TCP, HTTP) live in each model.",
            "keywords": "TCP/IP · four-layer model · Internet layer"
          },
          {
            "name": "Explore Network Interfaces",
            "status": "complete",
            "type": "Build",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/00-foundations/05-interfaces/",
            "path": "phases/networking/00-foundations/05-interfaces",
            "summary": "Use ip addr and ip link to list, configure, and bring up/down a virtual interface, observing how the kernel tracks state.",
            "keywords": "ip addr · ip link · virtual interface · NIC"
          }
        ]
      },
      {
        ...
        "status": "complete",
        "desc": "Understand how bits are encoded on the wire and how Ethernet frames deliver data within a local network.",
        "lessons": [
          {
            "name": "Trace Bits Across a Cable",
            "status": "complete",
            "type": "Learn",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/01-physical-and-datalink/01-physical-encoding/",
            "path": "phases/networking/01-physical-and-datalink/01-physical-encoding",
            "summary": "Simulate NRZ and Manchester encoding in a Python script to see how 1s and 0s map to voltage transitions.",
            "keywords": "NRZ · Manchester encoding · signal · baud rate"
          },
          {
            "name": "Dissect an Ethernet Frame",
            "status": "complete",
            "type": "Learn",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/01-physical-and-datalink/02-ethernet-frame/",
            "path": "phases/networking/01-physical-and-datalink/02-ethernet-frame",
            "summary": "Parse a raw Ethernet frame from a pcap file in Python, printing each field: destination MAC, source MAC, EtherType, payload.",
            "keywords": "Ethernet · MAC address · EtherType · frame parser"
          },
          {
            "name": "Understand MAC Addresses",
            "status": "complete",
            "type": "Learn",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/01-physical-and-datalink/03-mac-addresses/",
            "path": "phases/networking/01-physical-and-datalink/03-mac-addresses",
            "summary": "Look up the OUI for several MAC addresses, explain unicast vs. multicast vs. broadcast, and observe ARP resolve a MAC.",
            "keywords": "MAC address · OUI · ARP · broadcast"
          },
          {
            "name": "Build a Layer-2 Switch Simulation",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/01-physical-and-datalink/04-switch-simulation/",
            "path": "phases/networking/01-physical-and-datalink/04-switch-simulation",
            "summary": "Implement a forwarding table in Python that learns MAC-to-port mappings from frames and makes forwarding decisions.",
            "keywords": "switch · forwarding table · flooding · MAC learning"
          },
          {
            "name": "Observe VLANs with 802.1Q Tags",
            "status": "complete",
            "type": "Learn",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/01-physical-and-datalink/05-vlans/",
            "path": "phases/networking/01-physical-and-datalink/05-vlans",
            "summary": "Create two VLAN interfaces on a Linux bridge and verify that hosts on different VLANs cannot reach each other without a router.",
            "keywords": "VLAN · 802.1Q · trunk port · network segmentation"
          }
        ]
      },
      {
        ...
        "name": "The IP Layer",
        "status": "complete",
        "desc": "Master IPv4 addressing, subnetting, and routing so you can reason about where packets go and why.",
        "lessons": [
          {
            "name": "Decode IPv4 Addresses",
            "status": "complete",
            "type": "Learn",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/02-ip-layer/01-ipv4-addresses/",
            "path": "phases/networking/02-ip-layer/01-ipv4-addresses",
            "summary": "Write a Python script that converts dotted-decimal to binary, identifies the class, and extracts the host and network portions.",
            "keywords": "IPv4 · dotted-decimal · binary · address classes"
          },
          {
            "name": "Subnet a Network by Hand",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/02-ip-layer/02-subnetting/",
            "path": "phases/networking/02-ip-layer/02-subnetting",
            "summary": "Implement CIDR subnetting: given a base address and prefix length, compute the network address, broadcast, host range, and usable count.",
            "keywords": "CIDR · subnet mask · subnetting · host range"
          },
          {
            "name": "Parse an IPv4 Header",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/02-ip-layer/03-ipv4-header/",
            "path": "phases/networking/02-ip-layer/03-ipv4-header",
            "summary": "Use Python's struct module to unpack a raw IPv4 header from a pcap file, printing every field including TTL and flags.",
            "keywords": "IPv4 header · TTL · fragmentation · IHL"
          },
          {
            "name": "Trace a Packet with TTL",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/02-ip-layer/04-ttl-traceroute/",
            "path": "phases/networking/02-ip-layer/04-ttl-traceroute",
            "summary": "Implement a minimal traceroute in Python using raw sockets and TTL manipulation to discover each hop to a destination.",
            "keywords": "TTL · traceroute · ICMP time exceeded · raw socket"
          },
          {
            ...
            "type": "Build",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/02-ip-layer/05-static-routing/",
            "path": "phases/networking/02-ip-layer/05-static-routing",
            "summary": "Build a two-router topology with Linux network namespaces and ip route so that hosts on separate subnets can reach each other.",
            "keywords": "static route · ip route · network namespace · next hop"
          },
          {
            "name": "Understand NAT and Private Addresses",
            "status": "complete",
            "type": "Build",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/02-ip-layer/06-nat/",
            "path": "phases/networking/02-ip-layer/06-nat",
            "summary": "Configure iptables MASQUERADE to share one public IP across a private subnet and capture the address translation in Wireshark.",
            "keywords": "NAT · iptables · MASQUERADE · RFC 1918"
          }
        ]
      },
      {
        ...
        "status": "complete",
        "desc": "Implement TCP's reliability mechanisms and understand when to use UDP instead.",
        "lessons": [
          {
            "name": "Dissect a TCP Three-Way Handshake",
            "status": "complete",
            "type": "Learn",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/03-transport/01-tcp-handshake/",
            "path": "phases/networking/03-transport/01-tcp-handshake",
            "summary": "Capture a TCP connection with tcpdump, annotate the SYN, SYN-ACK, ACK packets, and explain why each flag is set.",
            "keywords": "TCP · three-way handshake · SYN · ACK · flags"
          },
          {
            "name": "Build a TCP Echo Server",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/03-transport/02-tcp-echo-server/",
            "path": "phases/networking/03-transport/02-tcp-echo-server",
            "summary": "Write a Python TCP server that accepts connections, reads lines, and echoes them back; test it with netcat.",
            "keywords": "socket · bind · listen · accept · echo server"
          },
          {
            "name": "Implement Stop-and-Wait ARQ",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/03-transport/03-arq/",
            "path": "phases/networking/03-transport/03-arq",
            "summary": "Implement stop-and-wait automatic repeat request over UDP sockets, adding sequence numbers, ACKs, and retransmission on timeout.",
            "keywords": "ARQ · stop-and-wait · sequence number · retransmission"
          },
          {
            "name": "Visualize TCP Sliding Window",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/03-transport/04-sliding-window/",
            "path": "phases/networking/03-transport/04-sliding-window",
            "summary": "Simulate a sliding window sender in Python, printing the window state after each ACK to show how throughput scales with window size.",
            "keywords": "sliding window · flow control · window size · throughput"
          },
          {
            "name": "Observe TCP Congestion Control",
            "status": "complete",
            "type": "Learn",
            "lang": "Python, Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/03-transport/05-congestion-control/",
            "path": "phases/networking/03-transport/05-congestion-control",
            "summary": "Use tc netem to inject packet loss and capture the cwnd trace in ss output to see slow start and AIMD in action.",
            "keywords": "congestion control · cwnd · slow start · AIMD · tc netem"
          },
          {
            "name": "Build a UDP Datagram Client",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/03-transport/06-udp-client/",
            "path": "phases/networking/03-transport/06-udp-client",
            "summary": "Write a UDP client that sends datagrams to a server, measures round-trip time per packet, and reports packet loss percentage.",
            "keywords": "UDP · datagram · RTT · packet loss · unreliable"
          }
        ]
      },
      {
        ...
        "name": "DNS",
        "status": "complete",
        "desc": "Understand how domain names resolve to IP addresses and build a stub resolver from scratch.",
        "lessons": [
          {
            ...
            "type": "Learn",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/04-dns/01-dns-trace/",
            "path": "phases/networking/04-dns/01-dns-trace",
            "summary": "Use dig +trace to walk the full DNS resolution chain from root servers to authoritative nameserver and explain each step.",
            "keywords": "DNS · dig · root server · authoritative nameserver · recursion"
          },
          {
            "name": "Parse a DNS Wire-Format Message",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/04-dns/02-dns-parser/",
            "path": "phases/networking/04-dns/02-dns-parser",
            "summary": "Write a Python parser that decodes a DNS response from bytes, printing the question, answer RRs, and TTL values.",
            "keywords": "DNS wire format · RR · TTL · struct · label encoding"
          },
          {
            "name": "Build a DNS Stub Resolver",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/04-dns/03-dns-stub-resolver/",
            "path": "phases/networking/04-dns/03-dns-stub-resolver",
            "summary": "Implement a DNS stub resolver over UDP that constructs a query, sends it to 8.8.8.8, and parses the A record response.",
            "keywords": "stub resolver · UDP · query ID · A record"
          },
          {
            "name": "Explore DNS Record Types",
            "status": "complete",
            "type": "Learn",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/04-dns/04-dns-record-types/",
            "path": "phases/networking/04-dns/04-dns-record-types",
            "summary": "Query A, AAAA, MX, TXT, CNAME, and NS records for a domain and explain when each record type is used.",
            "keywords": "A record · AAAA · MX · CNAME · NS · TXT"
          },
          {
            "name": "Understand DNS Caching and TTL",
            "status": "complete",
            "type": "Learn",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/04-dns/05-dns-caching/",
            "path": "phases/networking/04-dns/05-dns-caching",
            "summary": "Observe TTL decrement across repeated queries, explain negative caching, and demonstrate how a stale cache causes failures.",
            "keywords": "TTL · DNS cache · negative caching · NXDOMAIN"
          }
        ]
      },
      {
        ...
        "name": "HTTP & TLS",
        "status": "complete",
        "desc": "Build HTTP/1.1 clients and servers by hand, then add TLS to see exactly what encryption changes at the wire level.",
        "lessons": [
          {
            "name": "Send a Raw HTTP/1.1 Request",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/05-http-and-tls/01-raw-http/",
            "path": "phases/networking/05-http-and-tls/01-raw-http",
            "summary": "Open a TCP socket to example.com:80 and send a hand-crafted HTTP GET request, then parse the status line and headers.",
            "keywords": "HTTP/1.1 · raw socket · GET · request line · response headers"
          },
          {
            "name": "Build a Minimal HTTP Server",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/05-http-and-tls/02-http-server/",
            "path": "phases/networking/05-http-and-tls/02-http-server",
            "summary": "Write a Python server that handles GET requests, serves static files from a directory, and returns proper 404 responses.",
            "keywords": "HTTP server · socket · 200 OK · 404 · Content-Type"
          },
          {
            "name": "Understand HTTP Methods and Status Codes",
            "status": "complete",
            "type": "Learn",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/05-http-and-tls/03-http-methods/",
            "path": "phases/networking/05-http-and-tls/03-http-methods",
            "summary": "Extend the server to handle POST and DELETE, implement the correct status codes, and test each with curl.",
            "keywords": "POST · DELETE · PUT · 201 · 204 · 400 · 405"
          },
          {
            "name": "Trace a TLS Handshake",
            "status": "complete",
            "type": "Learn",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/05-http-and-tls/04-tls-handshake/",
            "path": "phases/networking/05-http-and-tls/04-tls-handshake",
            "summary": "Capture a TLS 1.3 handshake in Wireshark and label each message: ClientHello, ServerHello, Certificate, Finished.",
            "keywords": "TLS 1.3 · ClientHello · ServerHello · certificate · handshake"
          },
          {
            "name": "Add TLS to the HTTP Server",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/05-http-and-tls/05-https-server/",
            "path": "phases/networking/05-http-and-tls/05-https-server",
            "summary": "Wrap the HTTP server's socket with ssl.wrap_socket using a self-signed certificate and verify the connection with curl --cacert.",
            "keywords": "ssl module · self-signed cert · wrap_socket · HTTPS"
          },
          {
            "name": "Understand HTTP/2 Multiplexing",
            "status": "complete",
            "type": "Learn",
            "lang": "Python, Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/05-http-and-tls/06-http2/",
            "path": "phases/networking/05-http-and-tls/06-http2",
            "summary": "Use h2 library to make parallel requests over a single connection and compare waterfall timing against HTTP/1.1.",
            "keywords": "HTTP/2 · multiplexing · streams · HPACK · h2"
          }
        ]
      },
      {
        ...
        "status": "complete",
        "desc": "Understand how routers discover paths and propagate reachability information across large networks.",
        "lessons": [
          {
            "name": "Configure OSPF with FRRouting",
            "status": "complete",
            "type": "Build",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/06-routing-protocols/01-ospf/",
            "path": "phases/networking/06-routing-protocols/01-ospf",
            "summary": "Bring up a three-router FRRouting topology in Linux namespaces, enable OSPF, and verify routes appear in ip route.",
            "keywords": "OSPF · FRRouting · link-state · LSA · LSDB"
          },
          {
            "name": "Simulate Link Failure and Reconvergence",
            "status": "complete",
            "type": "Build",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/06-routing-protocols/02-reconvergence/",
            "path": "phases/networking/06-routing-protocols/02-reconvergence",
            "summary": "Take down a link in the OSPF topology and measure how long it takes traffic to reroute using ping timestamps.",
            "keywords": "reconvergence · SPF · Dijkstra · link failure"
          },
          {
            "name": "Explore BGP Path Selection",
            "status": "complete",
            "type": "Learn",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/06-routing-protocols/03-bgp/",
            "path": "phases/networking/06-routing-protocols/03-bgp",
            "summary": "Set up a two-AS FRRouting lab, advertise prefixes, and demonstrate how LOCAL_PREF and AS_PATH influence route selection.",
            "keywords": "BGP · AS · path selection · LOCAL_PREF · AS_PATH"
          },
          {
            "name": "Implement RIP in Python",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/06-routing-protocols/04-rip/",
            "path": "phases/networking/06-routing-protocols/04-rip",
            "summary": "Write a minimal RIP v2 implementation that exchanges distance-vector updates over UDP and converges a four-node topology.",
            "keywords": "RIP · distance vector · Bellman-Ford · routing table · UDP"
          },
          {
            "name": "Understand Anycast Routing",
            "status": "complete",
            "type": "Learn",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/06-routing-protocols/05-anycast/",
            "path": "phases/networking/06-routing-protocols/05-anycast",
            "summary": "Announce the same prefix from two locations in a FRRouting lab and verify that traffic lands at the topologically closest node.",
            "keywords": "anycast · BGP · prefix · CDN · DNS anycast"
          }
        ]
      },
      {
        ...
        "status": "complete",
        "desc": "Understand the most common network-layer attacks and implement packet filtering and monitoring defenses.",
        "lessons": [
          {
            ...
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/07-network-security/01-arp-spoofing/",
            "path": "phases/networking/07-network-security/01-arp-spoofing",
            "summary": "Write a Python script that sniffs ARP replies and alerts when a MAC-to-IP mapping changes unexpectedly on the local subnet.",
            "keywords": "ARP spoofing · MITM · Scapy · ARP cache poisoning"
          },
          {
            "name": "Write iptables Firewall Rules",
            "status": "complete",
            "type": "Build",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/07-network-security/02-iptables/",
            "path": "phases/networking/07-network-security/02-iptables",
            "summary": "Implement a stateful firewall policy with iptables that allows established outbound traffic and blocks all unsolicited inbound connections.",
            "keywords": "iptables · stateful firewall · ESTABLISHED · RELATED · DROP"
          },
          {
            "name": "Scan a Network with nmap",
            "status": "complete",
            "type": "Learn",
            "lang": "Bash",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/07-network-security/03-nmap/",
            "path": "phases/networking/07-network-security/03-nmap",
            "summary": "Run a SYN scan and service-version probe against a local lab host, interpret the output, and explain what each scan type reveals.",
            "keywords": "nmap · SYN scan · port scan · service detection · OS fingerprint"
          },
          {
            "name": "Implement a Port Knocker",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/07-network-security/04-port-knocking/",
            "path": "phases/networking/07-network-security/04-port-knocking",
            "summary": "Build a port-knocking daemon that opens a firewall rule only after receiving a specific sequence of connection attempts.",
            "keywords": "port knocking · iptables · pcap · hidden service"
          },
          {
            "name": "Understand TLS Certificate Validation",
            "status": "complete",
            "type": "Learn",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/07-network-security/05-tls-certificates/",
            "path": "phases/networking/07-network-security/05-tls-certificates",
            "summary": "Write a Python script that connects to a server and validates the certificate chain, catching expired, self-signed, and hostname mismatches.",
            "keywords": "TLS · certificate chain · CA · hostname validation · ssl"
          }
        ]
      },
      {
        ...
        "name": "Capstone Projects",
        "status": "complete",
        "desc": "Build four end-to-end networking tools that integrate everything from packet capture to application-layer protocols.",
        "lessons": [
          {
            "name": "Build a Packet Analyzer CLI",
            "status": "complete",
            "type": "Capstone",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/08-capstone-projects/01-packet-analyzer/",
            "path": "phases/networking/08-capstone-projects/01-packet-analyzer",
            "summary": "Write a command-line packet analyzer that reads a pcap file and produces a human-readable summary of each conversation by protocol.",
            "keywords": "pcap · Ethernet · IP · TCP · UDP · protocol breakdown"
          },
          {
            "name": "Build a Chat App Over Raw TCP",
            "status": "complete",
            "type": "Capstone",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/08-capstone-projects/02-tcp-chat/",
            "path": "phases/networking/08-capstone-projects/02-tcp-chat",
            "summary": "Implement a multi-client chat server using select() and a framed message protocol over TCP with length-prefixed messages.",
            "keywords": "TCP · select() · framing · length-prefix · multi-client"
          },
          {
            "name": "Implement a Mini HTTP Proxy",
            "status": "complete",
            "type": "Capstone",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/08-capstone-projects/03-http-proxy/",
            "path": "phases/networking/08-capstone-projects/03-http-proxy",
            "summary": "Build a forward proxy that intercepts HTTP requests, optionally rewrites headers, and logs each request to a structured file.",
            "keywords": "HTTP proxy · forward proxy · header rewriting · CONNECT · logging"
          },
          {
            "name": "Deploy a DNS-over-HTTPS Resolver",
            "status": "complete",
            "type": "Capstone",
            "lang": "Python",
            "url": "https://github.com/user/networking-from-scratch/tree/main/phases/08-capstone-projects/04-doh-resolver/",
            "path": "phases/networking/08-capstone-projects/04-doh-resolver",
            "summary": "Build a local DoH server that accepts standard DNS queries and forwards them over HTTPS to a public resolver, returning the decoded response.",
            "keywords": "DNS-over-HTTPS · DoH · TLS · resolver · privacy"
          }
        ]
      }
    ],
    "glossary": [
      {
        "term": "OSI Model",
        "says": "The thing with seven layers you memorize for exams",
        "means": "A conceptual framework dividing network functions into seven layers (Physical through Application) so each layer can evolve independently. Real protocols don't map cleanly onto it — TCP/IP is what the internet actually uses."
      },
      {
        "term": "TCP/IP Stack",
        "says": "Same as OSI but with four layers",
        "means": "The four-layer model (Link, Internet, Transport, Application) that describes how the internet actually works. Unlike OSI, it was designed around real deployed protocols."
      },
      {
        "term": "MAC Address",
        "says": "The hardware address burned into a NIC",
        "means": "A 48-bit identifier assigned to a network interface card, used for Layer 2 delivery within a local network segment. The first 24 bits identify the manufacturer (OUI); the rest are device-specific."
      },
      {
        "term": "IP Address",
        "says": "Your computer's address on the internet",
        "means": "A 32-bit (IPv4) or 128-bit (IPv6) number assigned to a network interface, used for routing packets across networks. Your public IP is assigned by your ISP; private IPs are assigned by your router via DHCP."
      },
      {
        "term": "Subnet Mask",
        "says": "The /24 after an IP address",
        "means": "A bitmask that divides an IP address into network and host portions. /24 means the first 24 bits identify the network; the remaining 8 bits identify individual hosts within it."
      },
      {
        "term": "CIDR",
        "says": "The slash notation for IP ranges",
        "means": "Classless Inter-Domain Routing — a notation (e.g., 192.168.1.0/24) and allocation method that replaced class-based addressing. It allows arbitrary prefix lengths, enabling more efficient IP space allocation."
      },
      {
        "term": "Default Gateway",
        "says": "The router your computer sends everything to",
        "means": "The IP address of the router that a host forwards packets to when the destination is outside its local subnet. If no more-specific route matches, the packet goes to the default gateway."
      },
      {
        "term": "ARP",
        "says": "How your computer finds MAC addresses",
        "means": "Address Resolution Protocol — a Layer 2 protocol that maps IPv4 addresses to MAC addresses on a local network. A host broadcasts 'who has 192.168.1.1?' and the owner replies with its MAC."
      },
      {
        "term": "TTL",
        "says": "A timer that deletes packets",
        "means": "Time To Live — an integer field in the IP header decremented by each router. When it reaches zero, the router discards the packet and sends an ICMP Time Exceeded message. It prevents packets from looping forever."
      },
      {
        "term": "TCP",
        "says": "The reliable one",
        "means": "Transmission Control Protocol — a connection-oriented, ordered, error-checked transport protocol. It provides reliability through sequence numbers, acknowledgements, and retransmission, at the cost of latency overhead."
      },
      {
        "term": "UDP",
        "says": "The fast, unreliable one",
        "means": "User Datagram Protocol — a connectionless transport protocol with no delivery guarantee, ordering, or retransmission. Used where low latency matters more than reliability: DNS, video streaming, games."
      },
      {
        "term": "Three-Way Handshake",
        "says": "How TCP connects",
        "means": "The SYN → SYN-ACK → ACK sequence TCP uses to establish a connection and negotiate initial sequence numbers. It consumes one round-trip before any data can be sent."
      },
      {
        "term": "Sequence Number",
        "says": "The packet counter TCP uses",
        "means": "A 32-bit value in the TCP header that labels the byte position of the first byte in a segment. The receiver uses it to reorder out-of-order segments and detect duplicates."
      },
      {
        "term": "Flow Control",
        "says": "Slowing down the sender",
        "means": "A TCP mechanism where the receiver advertises a window size (receive buffer space) so the sender doesn't overwhelm it. If the window is zero, the sender must pause until the receiver drains its buffer."
      },
      {
        "term": "Congestion Control",
        "says": "TCP slowing down because the network is busy",
        "means": "Algorithms (slow start, AIMD, CUBIC) that adjust TCP's sending rate based on inferred network congestion — usually signaled by packet loss or increased RTT. Prevents senders from collapsing the network."
      },
      {
        "term": "NAT",
        "says": "How a router shares one IP with many devices",
        "means": "Network Address Translation — a technique where a router rewrites source IP/port on outbound packets, allowing many private hosts to share one public IP. The router maintains a translation table to match replies to the originating host."
      },
      {
        "term": "DNS",
        "says": "The internet's phone book",
        "means": "Domain Name System — a distributed, hierarchical database that maps human-readable names (example.com) to IP addresses. Resolution starts at root servers, then TLD servers, then authoritative nameservers."
      },
      {
        "term": "Recursive Resolver",
        "says": "Your ISP's DNS server",
        "means": "A DNS server that accepts queries from clients and performs the full iterative resolution process on their behalf, caching results to speed up future lookups. Your router or ISP typically provides one."
      },
      {
        "term": "Authoritative Nameserver",
        "says": "The DNS server that actually knows the answer",
        "means": "A nameserver that holds the definitive records for a zone. Unlike a recursive resolver, it does not forward queries — it answers from its own database. Zone operators configure these via their domain registrar."
      },
      {
        "term": "A Record",
        "says": "The DNS record that maps a name to an IP",
        "means": "A DNS resource record type that maps a hostname to a single IPv4 address. Multiple A records for the same name create a round-robin pool. AAAA records are the IPv6 equivalent."
      },
      {
        "term": "CNAME",
        "says": "A DNS alias",
        "means": "Canonical Name record — a DNS record that aliases one name to another. Resolvers follow the chain until they reach an A or AAAA record. CNAMEs cannot coexist with other record types at the same name."
      },
      {
        "term": "HTTP",
        "says": "The protocol websites use",
        "means": "HyperText Transfer Protocol — a stateless, request-response, application-layer protocol that runs over TCP. A client sends a method (GET, POST, etc.) and a path; the server responds with a status code and body."
      },
      {
        "term": "TLS",
        "says": "The S in HTTPS",
        "means": "Transport Layer Security — a cryptographic protocol that provides confidentiality, integrity, and authentication over TCP. It negotiates a cipher suite and keys in a handshake before application data flows."
      },
      {
        "term": "Port",
        "says": "The number after the colon in an address",
        "means": "A 16-bit number in the TCP or UDP header that identifies which process on a host should receive a packet. Ports below 1024 are reserved for well-known services (80=HTTP, 443=HTTPS, 53=DNS, 22=SSH)."
      },
      {
        "term": "Socket",
        "says": "The thing you open to send data",
        "means": "An OS abstraction for a network endpoint identified by (protocol, local IP, local port, remote IP, remote port). Programs read and write sockets like files; the kernel handles the actual protocol mechanics."
      },
      {
        "term": "Firewall",
        "says": "The thing that blocks ports",
        "means": "A packet filter that inspects headers (and optionally state) to allow or deny traffic based on rules. Stateful firewalls track connection state to allow established sessions without an explicit return rule."
      },
      {
        "term": "ICMP",
        "says": "The ping protocol",
        "means": "Internet Control Message Protocol — a network-layer protocol used by hosts and routers to report errors and diagnostics. Echo Request/Reply enable ping; Time Exceeded enables traceroute."
      },
      {
        "term": "BGP",
        "says": "How the internet routes between ISPs",
        "means": "Border Gateway Protocol — the inter-domain routing protocol that connects autonomous systems (ISPs, cloud providers) to each other. Each AS advertises its prefixes and selects routes based on policy attributes like LOCAL_PREF and AS_PATH."
      },
      {
        "term": "OSPF",
        "says": "The routing protocol inside a network",
        "means": "Open Shortest Path First — a link-state interior gateway protocol. Each router floods LSAs to build a map of the entire network, then runs Dijkstra's algorithm to compute shortest paths to every destination."
      },
      {
        "term": "Latency",
        "says": "How slow the network is",
        "means": "The time for one packet to travel from source to destination, typically measured as round-trip time (RTT). Dominated by propagation delay (speed of light over distance) for long-haul links."
      },
      {
        "term": "Bandwidth",
        "says": "How fast the network is",
        "means": "The maximum rate at which data can be transmitted over a link, measured in bits per second. Bandwidth and latency are independent; a high-bandwidth satellite link can still have 600ms RTT."
      },
      {
        "term": "Packet Loss",
        "says": "When packets disappear",
        "means": "The fraction of packets that fail to reach the destination, typically due to router buffer overflow or link errors. TCP detects loss via timeout or duplicate ACKs and retransmits; UDP does not."
      },
      {
        "term": "MTU",
        "says": "The maximum packet size",
        "means": "Maximum Transmission Unit — the largest payload an interface can carry without fragmentation. Ethernet's MTU is 1500 bytes. If a packet exceeds the MTU on a path, it is fragmented (IPv4) or the sender is notified (IPv6)."
      },
      {
        "term": "DHCP",
        "says": "How devices get their IP address automatically",
        "means": "Dynamic Host Configuration Protocol — a UDP-based protocol where a client broadcasts a request and a DHCP server assigns an IP address, subnet mask, default gateway, and DNS server for a lease period."
      },
      {
        "term": "VPN",
        "says": "A secure tunnel through the internet",
        "means": "Virtual Private Network — a technique that encapsulates and encrypts packets inside another protocol so a remote host appears to be on a private network. Common implementations include WireGuard, OpenVPN, and IPsec."
      },
      {
        "term": "CDN",
        "says": "The servers that make websites load fast",
        "means": "Content Delivery Network — a distributed set of servers that cache static assets close to users. CDNs use anycast routing and DNS-based load balancing to direct users to the nearest cache node."
      },
      {
        "term": "Wireshark",
        "says": "The GUI for reading network packets",
        "means": "A packet capture and protocol analyzer that decodes raw frames and renders each field in a tree view. It uses libpcap under the hood; tcpdump is the command-line equivalent."
      },
      {
        "term": "tcpdump",
        "says": "Wireshark but in the terminal",
        "means": "A command-line packet capture tool that writes pcap files or displays decoded packet summaries. Filters use BPF syntax (e.g., tcp port 80) to limit what is captured."
      },
      {
        "term": "netcat",
        "says": "The Swiss army knife of networking",
        "means": "A utility that reads and writes raw TCP or UDP data. Used to test open ports, send HTTP requests by hand, create reverse shells in labs, and pipe data over a network connection."
      }
    ],
    "artifacts": [],
    "prereqs": {
  ...
  },
  {
    ...
    "tagline": "44 lessons. 9 phases. From a single server to globally distributed systems — build the mental models behind scalable architecture.",
    "description": "A ground-up course on designing large-scale systems: how to estimate load, store and cache data, scale across machines, reason about consistency, and stitch services together with queues and APIs. Each phase pairs the concept with runnable code — a consistent hashing ring, an LRU cache, a token-bucket rate limiter — so the abstractions stay concrete, and ends in capstone designs of real systems.",
    "githubRepo": "Linzo99/anything-from-scratch",
    "githubBranch": "main",
    "contentHost": "local",
    "phases": [
      {
        ...
        "name": "Foundations",
        "status": "complete",
        "desc": "Learn what system design actually is, how to turn vague requirements into numbers, and the framework you use to attack any design problem.",
        "lessons": [
          {
            ...
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/00-foundations/01-what-is-system-design/",
            "path": "phases/system-design/00-foundations/01-what-is-system-design",
            "summary": "Define system design as the practice of trading off scalability, availability, latency, consistency, and cost, and map the building blocks you will use throughout the course.",
            "keywords": "scalability · availability · latency · tradeoffs"
          },
          {
            "name": "Requirements & Tradeoffs",
            "status": "complete",
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/00-foundations/02-requirements-and-tradeoffs/",
            "path": "phases/system-design/00-foundations/02-requirements-and-tradeoffs",
            "summary": "Separate functional from non-functional requirements and turn fuzzy goals like 'fast' and 'reliable' into measurable SLAs.",
            "keywords": "functional · non-functional · SLA · constraints"
          },
          {
            ...
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/00-foundations/03-back-of-the-envelope-estimation/",
            "path": "phases/system-design/00-foundations/03-back-of-the-envelope-estimation",
            "summary": "Write a Python estimator that turns daily active users into QPS, storage, and bandwidth numbers you can defend in a design review.",
            "keywords": "QPS · storage estimate · bandwidth · powers of two"
          },
          {
            ...
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/00-foundations/04-the-design-framework/",
            "path": "phases/system-design/00-foundations/04-the-design-framework",
            "summary": "Apply a repeatable 6-step framework — requirements, estimation, API, data model, high-level design, deep dive — to structure any design problem.",
            "keywords": "framework · high-level design · deep dive · bottlenecks"
          }
        ]
      },
      {
        ...
        "status": "complete",
        "desc": "Understand how requests find your servers and how clients talk to them: DNS, load balancers, proxies, and the API styles you choose between.",
        "lessons": [
          {
            ...
            "type": "Learn",
            "lang": "Bash",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/01-networking-and-apis/01-dns-and-domain-resolution/",
            "path": "phases/system-design/01-networking-and-apis/01-dns-and-domain-resolution",
            "summary": "Trace a domain name from browser to IP through recursive resolvers, and use DNS records for routing and failover.",
            "keywords": "DNS · A record · TTL · GeoDNS"
          },
          {
            "name": "Load Balancing",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/01-networking-and-apis/02-load-balancing/",
            "path": "phases/system-design/01-networking-and-apis/02-load-balancing",
            "summary": "Build a load balancer in Python that distributes requests across backends with round-robin, least-connections, and weighted strategies.",
            "keywords": "load balancer · round-robin · health check · L4 vs L7"
          },
          {
            "name": "Proxies & API Gateways",
            "status": "complete",
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/01-networking-and-apis/03-proxies-and-api-gateways/",
            "path": "phases/system-design/01-networking-and-apis/03-proxies-and-api-gateways",
            "summary": "Distinguish forward proxies, reverse proxies, and API gateways, and place each correctly in a request path.",
            "keywords": "reverse proxy · API gateway · TLS termination · cross-cutting"
          },
          {
            ...
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/01-networking-and-apis/04-api-design-rest-grpc-graphql/",
            "path": "phases/system-design/01-networking-and-apis/04-api-design-rest-grpc-graphql",
            "summary": "Implement the same endpoint three ways and compare REST, gRPC, and GraphQL on payload size, coupling, and tooling.",
            "keywords": "REST · gRPC · GraphQL · protobuf"
          },
          {
            "name": "Realtime: WebSockets & Polling",
            "status": "complete",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/01-networking-and-apis/05-realtime-websockets-and-polling/",
            "path": "phases/system-design/01-networking-and-apis/05-realtime-websockets-and-polling",
            "summary": "Compare short polling, long polling, SSE, and WebSockets by building a live counter and measuring each approach's overhead.",
            "keywords": "WebSocket · long polling · SSE · push"
          }
        ]
      },
      {
        ...
        "name": "Data Storage",
        "status": "complete",
        "desc": "Pick the right store for the job: relational vs non-relational models, how indexes make queries fast, what ACID guarantees, and where blobs live.",
        "lessons": [
          {
            "name": "SQL vs NoSQL",
            "status": "complete",
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/02-data-storage/01-sql-vs-nosql/",
            "path": "phases/system-design/02-data-storage/01-sql-vs-nosql",
            "summary": "Map workloads to data models — relational, key-value, document, wide-column, graph — and justify the choice with access patterns.",
            "keywords": "relational · key-value · document · access patterns"
          },
          {
            ...
            "type": "Build",
            "lang": "SQL",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/02-data-storage/02-indexing-and-query-performance/",
            "path": "phases/system-design/02-data-storage/02-indexing-and-query-performance",
            "summary": "Create B-tree indexes in SQLite, read query plans with EXPLAIN, and measure the speedup from indexing a million-row table.",
            "keywords": "B-tree · EXPLAIN · composite index · full scan"
          },
          {
            ...
            "type": "Learn",
            "lang": "SQL",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/02-data-storage/03-acid-and-transactions/",
            "path": "phases/system-design/02-data-storage/03-acid-and-transactions",
            "summary": "Explain atomicity, consistency, isolation, and durability and reproduce a dirty-read and lost-update with isolation levels.",
            "keywords": "ACID · isolation levels · locking · MVCC"
          },
          {
            ...
            "type": "Build",
            "lang": "SQL",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/02-data-storage/04-data-modeling-and-schema-design/",
            "path": "phases/system-design/02-data-storage/04-data-modeling-and-schema-design",
            "summary": "Model a real domain with normalized tables, then denormalize deliberately for read-heavy access and justify each tradeoff.",
            "keywords": "normalization · denormalization · foreign keys · star schema"
          },
          {
            ...
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/02-data-storage/05-object-and-blob-storage/",
            "path": "phases/system-design/02-data-storage/05-object-and-blob-storage",
            "summary": "Explain why large files belong in object stores like S3 rather than databases, and design upload/download paths with presigned URLs.",
            "keywords": "object storage · S3 · presigned URL · CDN origin"
          }
        ]
      },
      {
        ...
        "name": "Caching & CDNs",
        "status": "in-progress",
        "desc": "Make reads fast and cheap: where to put a cache, how to keep it fresh, which entries to evict, and how CDNs push content to the edge.",
        "lessons": [
          {
            "name": "Why Cache",
            "status": "in-progress",
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/03-caching-and-cdns/01-why-cache/",
            "path": "phases/system-design/03-caching-and-cdns/01-why-cache",
            "summary": "Quantify how caching cuts latency and load, and identify every layer of a stack where a cache can live.",
            "keywords": "cache hit ratio · latency · locality · cache layers"
          },
          {
            ...
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/03-caching-and-cdns/02-caching-strategies/",
            "path": "phases/system-design/03-caching-and-cdns/02-caching-strategies",
            "summary": "Implement cache-aside, write-through, and write-back in Python and reason about staleness and consistency for each.",
            "keywords": "cache-aside · write-through · write-back · invalidation"
          },
          {
            "name": "Eviction Policies & LRU",
            "status": "in-progress",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/03-caching-and-cdns/03-eviction-policies-and-lru/",
            "path": "phases/system-design/03-caching-and-cdns/03-eviction-policies-and-lru",
            "summary": "Build an O(1) LRU cache with a hash map and doubly linked list, then compare it against LFU and FIFO on a real trace.",
            "keywords": "LRU · LFU · eviction · doubly linked list"
          },
          {
            ...
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/03-caching-and-cdns/04-distributed-caching-with-redis/",
            "path": "phases/system-design/03-caching-and-cdns/04-distributed-caching-with-redis",
            "summary": "Use Redis as a shared cache, handle the thundering-herd and stampede problems, and reason about cache cluster topology.",
            "keywords": "Redis · TTL · stampede · thundering herd"
          },
          {
            "name": "CDNs & Edge Caching",
            "status": "in-progress",
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/03-caching-and-cdns/05-cdns-and-edge-caching/",
            "path": "phases/system-design/03-caching-and-cdns/05-cdns-and-edge-caching",
            "summary": "Explain how CDNs use anycast and edge PoPs to serve content near users, and design cache-control headers for correct invalidation.",
            "keywords": "CDN · edge PoP · anycast · cache-control"
          }
        ]
      },
      {
        "id": 4,
        "name": "Scaling & Partitioning",
        "status": "in-progress",
        "desc": "Grow past one machine: replicate for reads, shard for writes, keep services stateless, and distribute load evenly with consistent hashing.",
        "lessons": [
          {
            ...
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/04-scaling-and-partitioning/01-vertical-vs-horizontal-scaling/",
            "path": "phases/system-design/04-scaling-and-partitioning/01-vertical-vs-horizontal-scaling",
            "summary": "Compare scaling up versus scaling out, and identify when each hits a wall in cost, availability, or complexity.",
            "keywords": "scale up · scale out · single point of failure · elasticity"
          },
          {
            ...
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/04-scaling-and-partitioning/02-database-replication/",
            "path": "phases/system-design/04-scaling-and-partitioning/02-database-replication",
            "summary": "Explain single-leader, multi-leader, and leaderless replication and the read-after-write and replication-lag problems each creates.",
            "keywords": "replication · leader-follower · replication lag · failover"
          },
          {
            ...
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/04-scaling-and-partitioning/03-sharding-and-partitioning/",
            "path": "phases/system-design/04-scaling-and-partitioning/03-sharding-and-partitioning",
            "summary": "Partition data by range and by hash in Python, expose the hot-shard problem, and design a partition key that spreads load.",
            "keywords": "sharding · partition key · hot shard · rebalancing"
          },
          {
            ...
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/04-scaling-and-partitioning/04-consistent-hashing/",
            "path": "phases/system-design/04-scaling-and-partitioning/04-consistent-hashing",
            "summary": "Build a consistent hashing ring with virtual nodes and measure how few keys move when a node joins or leaves.",
            "keywords": "consistent hashing · hash ring · virtual nodes · key movement"
          },
          {
            "name": "Stateless Services & Sessions",
            "status": "in-progress",
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/04-scaling-and-partitioning/05-stateless-services-and-sessions/",
            "path": "phases/system-design/04-scaling-and-partitioning/05-stateless-services-and-sessions",
            "summary": "Move session state out of app servers so any instance can handle any request, and compare sticky sessions to a shared session store.",
            "keywords": "stateless · sticky sessions · JWT · session store"
          }
        ]
      },
      {
        ...
        "status": "in-progress",
        "desc": "The hard part: what CAP really says, the spectrum of consistency models, how nodes agree with consensus, and why clocks lie.",
        "lessons": [
          {
            ...
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/05-distributed-systems-theory/01-the-cap-theorem/",
            "path": "phases/system-design/05-distributed-systems-theory/01-the-cap-theorem",
            "summary": "State CAP precisely — that during a partition you choose consistency or availability — and apply it to real datastore choices.",
            "keywords": "CAP · partition tolerance · CP · AP"
          },
          {
            ...
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/05-distributed-systems-theory/02-consistency-models/",
            "path": "phases/system-design/05-distributed-systems-theory/02-consistency-models",
            "summary": "Order the consistency spectrum from strong to eventual and pick the weakest model that still satisfies the requirements.",
            "keywords": "strong consistency · eventual · linearizability · read-your-writes"
          },
          {
            "name": "Consensus & Raft",
            "status": "in-progress",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/05-distributed-systems-theory/03-consensus-and-raft/",
            "path": "phases/system-design/05-distributed-systems-theory/03-consensus-and-raft",
            "summary": "Simulate Raft leader election and log replication in Python to see how a cluster agrees on a single value despite failures.",
            "keywords": "consensus · Raft · leader election · quorum"
          },
          {
            ...
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/05-distributed-systems-theory/04-time-clocks-and-ordering/",
            "path": "phases/system-design/05-distributed-systems-theory/04-time-clocks-and-ordering",
            "summary": "Implement Lamport and vector clocks to order events across machines without trusting wall-clock time.",
            "keywords": "Lamport clock · vector clock · happens-before · causality"
          },
          {
            ...
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/05-distributed-systems-theory/05-leader-election-and-coordination/",
            "path": "phases/system-design/05-distributed-systems-theory/05-leader-election-and-coordination",
            "summary": "Use coordination services like ZooKeeper/etcd for leader election, locks, and config, and reason about split-brain.",
            "keywords": "ZooKeeper · etcd · distributed lock · split-brain"
          }
        ]
      },
      {
        ...
        "status": "planned",
        "desc": "Decouple producers from consumers: queues for work, pub/sub for fan-out, logs like Kafka for replay, and how to handle duplicates.",
        "lessons": [
          {
            "name": "Message Queues",
            "status": "planned",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/06-async-and-messaging/01-message-queues/",
            "path": "phases/system-design/06-async-and-messaging/01-message-queues",
            "summary": "Build a producer/consumer queue with a worker pool in Python and absorb a traffic spike without dropping work.",
            "keywords": "queue · producer-consumer · worker pool · backpressure"
          },
          {
            "name": "Pub/Sub & Event-Driven Design",
            "status": "planned",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/06-async-and-messaging/02-pub-sub-and-event-driven/",
            "path": "phases/system-design/06-async-and-messaging/02-pub-sub-and-event-driven",
            "summary": "Implement a topic-based pub/sub broker so one event fans out to many independent subscribers.",
            "keywords": "pub/sub · topic · fan-out · event-driven"
          },
          {
            "name": "Kafka & Log-Based Streaming",
            "status": "planned",
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/06-async-and-messaging/03-kafka-and-log-based-streaming/",
            "path": "phases/system-design/06-async-and-messaging/03-kafka-and-log-based-streaming",
            "summary": "Explain the partitioned append-only log model behind Kafka, consumer groups, offsets, and why replay changes architecture.",
            "keywords": "Kafka · partitioned log · consumer group · offset"
          },
          {
            ...
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/06-async-and-messaging/04-stream-processing/",
            "path": "phases/system-design/06-async-and-messaging/04-stream-processing",
            "summary": "Contrast batch and stream processing and design windowed aggregations over an unbounded event stream.",
            "keywords": "stream processing · windowing · watermark · batch vs stream"
          },
          {
            "name": "Idempotency & Delivery Guarantees",
            "status": "planned",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/06-async-and-messaging/05-idempotency-and-delivery-guarantees/",
            "path": "phases/system-design/06-async-and-messaging/05-idempotency-and-delivery-guarantees",
            "summary": "Implement idempotent consumers with dedup keys and reason about at-most-once, at-least-once, and exactly-once delivery.",
            "keywords": "idempotency · at-least-once · exactly-once · dedup"
          }
        ]
      },
      {
        ...
        "status": "planned",
        "desc": "Keep systems up and visible: limit abusive traffic, fail gracefully, design for redundancy, and measure everything against SLOs.",
        "lessons": [
          {
            "name": "Rate Limiting",
            "status": "planned",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/07-reliability-and-observability/01-rate-limiting/",
            "path": "phases/system-design/07-reliability-and-observability/01-rate-limiting",
            "summary": "Implement token-bucket and sliding-window rate limiters and choose limits that protect a service without harming real users.",
            "keywords": "rate limiting · token bucket · sliding window · 429"
          },
          {
            "name": "Circuit Breakers & Retries",
            "status": "planned",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/07-reliability-and-observability/02-circuit-breakers-and-retries/",
            "path": "phases/system-design/07-reliability-and-observability/02-circuit-breakers-and-retries",
            "summary": "Build a circuit breaker with retry-and-backoff and jitter, and show how naive retries cause a retry storm.",
            "keywords": "circuit breaker · exponential backoff · jitter · retry storm"
          },
          {
            "name": "Fault Tolerance & Redundancy",
            "status": "planned",
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/07-reliability-and-observability/03-fault-tolerance-and-redundancy/",
            "path": "phases/system-design/07-reliability-and-observability/03-fault-tolerance-and-redundancy",
            "summary": "Eliminate single points of failure with redundancy, failover, and multi-AZ deployment, and compute availability from components.",
            "keywords": "redundancy · failover · multi-AZ · availability math"
          },
          {
            ...
            "type": "Learn",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/07-reliability-and-observability/04-monitoring-and-observability/",
            "path": "phases/system-design/07-reliability-and-observability/04-monitoring-and-observability",
            "summary": "Instrument the three pillars — metrics, logs, traces — and design dashboards and alerts that catch problems before users do.",
            "keywords": "metrics · logs · tracing · alerting"
          },
          {
            "name": "SLOs & Capacity Planning",
            "status": "planned",
            "type": "Build",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/07-reliability-and-observability/05-slos-and-capacity-planning/",
            "path": "phases/system-design/07-reliability-and-observability/05-slos-and-capacity-planning",
            "summary": "Compute SLIs, error budgets, and percentile latency from raw request logs and plan capacity for projected growth.",
            "keywords": "SLO · SLI · error budget · p99"
          }
        ]
      },
      {
        ...
        "name": "Capstone Projects",
        "status": "planned",
        "desc": "Put it all together: full end-to-end designs of systems you have used, with estimation, data model, API, scaling plan, and tradeoffs.",
        "lessons": [
          {
            ...
            "type": "Capstone",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/08-capstone-projects/01-design-a-url-shortener/",
            "path": "phases/system-design/08-capstone-projects/01-design-a-url-shortener",
            "summary": "Design and prototype a URL shortener: key generation, redirect path, read-heavy caching, and analytics at scale.",
            "keywords": "URL shortener · base62 · redirect · read-heavy"
          },
          {
            "name": "Design a Rate Limiter Service",
            "status": "planned",
            "type": "Capstone",
            "lang": "Python",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/08-capstone-projects/02-design-a-rate-limiter-service/",
            "path": "phases/system-design/08-capstone-projects/02-design-a-rate-limiter-service",
            "summary": "Design a distributed rate limiter shared across many app servers using Redis, with correct counting under concurrency.",
            "keywords": "distributed rate limiter · Redis · atomicity · sliding log"
          },
          {
            "name": "Design a Twitter News Feed",
            "status": "planned",
            "type": "Capstone",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/08-capstone-projects/03-design-a-twitter-news-feed/",
            "path": "phases/system-design/08-capstone-projects/03-design-a-twitter-news-feed",
            "summary": "Design a social news feed and resolve the fan-out-on-write vs fan-out-on-read tradeoff for celebrity accounts.",
            "keywords": "news feed · fan-out · timeline · celebrity problem"
          },
          {
            ...
            "type": "Capstone",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/08-capstone-projects/04-design-a-chat-system/",
            "path": "phases/system-design/08-capstone-projects/04-design-a-chat-system",
            "summary": "Design a realtime chat system with WebSocket gateways, message storage, presence, and delivery/read receipts.",
            "keywords": "chat · WebSocket · presence · delivery receipt"
          },
          {
            ...
            "type": "Capstone",
            "lang": "Markdown",
            "url": "https://github.com/Linzo99/anything-from-scratch/tree/main/phases/08-capstone-projects/05-design-a-video-streaming-platform/",
            "path": "phases/system-design/08-capstone-projects/05-design-a-video-streaming-platform",
            "summary": "Design a video platform: upload and transcoding pipeline, adaptive bitrate streaming, and CDN-backed delivery at scale.",
            "keywords": "video · transcoding · adaptive bitrate · CDN"
          }
        ]
      }
    ],
    "glossary": [
      {
        "term": "Scalability",
        "says": "Handle more users",
        "means": "The ability of a system to handle increased load by adding resources, ideally with throughput growing proportionally to resources added."
      },
      {
        "term": "Availability",
        "says": "The system is up",
        "means": "The fraction of time a system is operational and able to serve requests, usually expressed in nines (99.9% = ~8.7 hours of downtime per year)."
      },
      {
        "term": "Latency",
        "says": "How long it takes",
        "means": "The time to service a single request, measured end to end. Often reported as percentiles (p50, p99) rather than averages because tails matter."
      },
      {
        "term": "Throughput",
        "says": "How much it can do",
        "means": "The number of operations a system completes per unit time, e.g. requests per second (QPS). Distinct from latency: a batch system can have high throughput and high latency."
      },
      {
        "term": "QPS",
        "says": "Requests per second",
        "means": "Queries per second — the request rate a service handles. Peak QPS, not average, drives capacity planning."
      },
      {
        "term": "SLA",
        "says": "The uptime promise",
        "means": "Service Level Agreement — a contractual guarantee about availability or latency, with penalties if missed. Built from internal SLOs and SLIs."
      },
      {
        "term": "SLO",
        "says": "The internal target",
        "means": "Service Level Objective — the target value for a metric (e.g. 99.9% of requests under 200ms) that the team commits to internally."
      },
      {
        "term": "SLI",
        "says": "The measured number",
        "means": "Service Level Indicator — the actual measured metric (e.g. the observed p99 latency) that an SLO is defined against."
      },
      {
        "term": "Load balancer",
        "says": "Spreads traffic out",
        "means": "A component that distributes incoming requests across multiple backend servers using a strategy like round-robin or least-connections, often with health checks."
      },
      {
        "term": "Reverse proxy",
        "says": "Server-side proxy",
        "means": "A proxy that sits in front of backend servers and forwards client requests to them, often handling TLS termination, caching, and load balancing."
      },
      {
        "term": "API gateway",
        "says": "The front door",
        "means": "A reverse proxy specialized for APIs that centralizes cross-cutting concerns: authentication, rate limiting, routing, and request aggregation."
      },
      {
        "term": "DNS",
        "says": "Turns names into IPs",
        "means": "Domain Name System — the distributed directory that resolves human-readable domain names to IP addresses through a hierarchy of recursive and authoritative servers."
      },
      {
        "term": "CDN",
        "says": "Makes sites load fast",
        "means": "Content Delivery Network — a geographically distributed set of edge caches that serve static (and sometimes dynamic) content close to users via anycast routing."
      },
      {
        "term": "Cache",
        "says": "Fast temporary storage",
        "means": "A high-speed store holding copies of data so future reads avoid a slower source. Defined by its eviction policy, size, and consistency with the source of truth."
      },
      {
        "term": "Cache hit ratio",
        "says": "How often the cache helps",
        "means": "The fraction of requests served from cache rather than the origin. A small ratio increase can dramatically reduce backend load."
      },
      {
        "term": "Cache-aside",
        "says": "App manages the cache",
        "means": "A caching pattern where the application checks the cache, and on a miss reads the database and populates the cache itself. Also called lazy loading."
      },
      {
        "term": "LRU",
        "says": "Evict the oldest-used",
        "means": "Least Recently Used — an eviction policy that discards the entry not accessed for the longest time, typically implemented with a hash map plus a doubly linked list for O(1) operations."
      },
      {
        "term": "Replication",
        "says": "Copy the data",
        "means": "Keeping copies of data on multiple nodes for availability and read scaling. Variants include single-leader, multi-leader, and leaderless."
      },
      {
        "term": "Replication lag",
        "says": "Followers fall behind",
        "means": "The delay between a write committing on the leader and appearing on a follower. Causes read-after-write anomalies if a client reads from a stale replica."
      },
      {
        "term": "Sharding",
        "says": "Split the data up",
        "means": "Partitioning a dataset across multiple nodes so each holds a subset, enabling writes and storage to scale horizontally. Requires choosing a partition key."
      },
      {
        "term": "Partition key",
        "says": "How rows are split",
        "means": "The attribute used to decide which shard a record lives on. A poor choice creates hot shards; a good one spreads load evenly."
      },
      {
        "term": "Hot shard",
        "says": "One shard is overloaded",
        "means": "A partition that receives disproportionate traffic because of a skewed partition key (e.g. sharding by country when one country dominates)."
      },
      {
        "term": "Consistent hashing",
        "says": "Hashing that survives resizing",
        "means": "A hashing scheme that maps keys and nodes onto a ring so that adding or removing a node moves only a small fraction of keys, not the whole keyspace."
      },
      {
        "term": "Virtual node",
        "says": "Many points per server",
        "means": "Multiple positions on a consistent hashing ring assigned to one physical node, used to smooth out uneven key distribution."
      },
      {
        "term": "CAP theorem",
        "says": "Pick two of three",
        "means": "During a network partition a distributed system must choose between consistency and availability; partition tolerance is non-negotiable, so the real choice is CP vs AP."
      },
      {
        "term": "Strong consistency",
        "says": "Always see latest write",
        "means": "A model where every read returns the most recent committed write. Linearizability is the strongest form. Costs latency and availability under partitions."
      },
      {
        "term": "Eventual consistency",
        "says": "Catches up later",
        "means": "A model where replicas converge to the same value given no new writes, but reads may temporarily return stale data. Common in AP systems."
      },
      {
        "term": "Linearizability",
        "says": "Acts like one copy",
        "means": "The strongest single-object consistency: operations appear to take effect instantaneously in some real-time order consistent with their actual timing."
      },
      {
        "term": "Consensus",
        "says": "Nodes agree",
        "means": "The problem of getting multiple nodes to agree on a single value despite failures. Solved by protocols like Raft and Paxos using quorums."
      },
      {
        "term": "Raft",
        "says": "Understandable consensus",
        "means": "A consensus algorithm built around an elected leader that replicates an append-only log to followers, committing entries once a quorum acknowledges them."
      },
      {
        "term": "Quorum",
        "says": "A majority agrees",
        "means": "The minimum number of nodes that must respond for an operation to succeed. With N nodes, a write/read quorum of W+R > N guarantees overlap."
      },
      {
        "term": "Lamport clock",
        "says": "Logical timestamp",
        "means": "A counter that increments on each event and on message receipt takes the max of local and received values, establishing a partial happens-before order."
      },
      {
        "term": "Vector clock",
        "says": "Per-node counters",
        "means": "An array of logical counters, one per node, that can detect whether two events are causally ordered or concurrent."
      },
      {
        "term": "Split-brain",
        "says": "Two leaders at once",
        "means": "A failure where a partition causes two nodes to each believe they are leader, leading to divergent writes. Prevented with quorums and fencing."
      },
      {
        "term": "Message queue",
        "says": "Buffer for work",
        "means": "A component that holds messages between producers and consumers, decoupling them in time and absorbing load spikes via backpressure."
      },
      {
        "term": "Pub/sub",
        "says": "Broadcast to subscribers",
        "means": "Publish/subscribe — a messaging pattern where publishers send to a topic and every subscriber receives a copy, enabling fan-out."
      },
      {
        "term": "Kafka",
        "says": "A big log",
        "means": "A distributed, partitioned, append-only commit log. Consumers track their own offset, enabling replay and multiple independent reads of the same stream."
      },
      {
        "term": "Idempotency",
        "says": "Safe to retry",
        "means": "A property where performing an operation multiple times has the same effect as performing it once, essential for safe retries in at-least-once delivery."
      },
      {
        "term": "At-least-once",
        "says": "Maybe duplicates",
        "means": "A delivery guarantee where every message is delivered, but possibly more than once. Combined with idempotent consumers to achieve effective exactly-once."
      },
      {
        "term": "Backpressure",
        "says": "Slow down the producer",
        "means": "A mechanism by which a slow consumer signals upstream to reduce the rate of incoming work, preventing unbounded queue growth and memory exhaustion."
      },
      {
        "term": "Rate limiting",
        "says": "Cap the request rate",
        "means": "Restricting how many requests a client may make in a window to protect a service. Common algorithms: token bucket, leaky bucket, sliding window."
      },
      {
        "term": "Token bucket",
        "says": "Refilling allowance",
        "means": "A rate-limiting algorithm where tokens refill at a fixed rate up to a capacity; each request consumes a token, allowing bursts up to the bucket size."
      },
      {
        "term": "Circuit breaker",
        "says": "Stop calling a dead service",
        "means": "A pattern that trips open after repeated failures to a dependency, failing fast instead of piling up calls, then probes periodically to recover."
      },
      {
        "term": "Exponential backoff",
        "says": "Wait longer each retry",
        "means": "A retry strategy where the wait between attempts grows exponentially (often with random jitter) to avoid synchronized retry storms."
      },
      {
        "term": "Single point of failure",
        "says": "One thing kills it",
        "means": "A component whose failure takes down the whole system. Eliminated through redundancy and failover."
      },
      {
        "term": "Error budget",
        "says": "Allowed failure",
        "means": "The amount of unreliability permitted by an SLO (e.g. 0.1% of requests may fail). Spending it gates risky releases."
      },
      {
        "term": "p99 latency",
        "says": "The slow tail",
        "means": "The latency value below which 99% of requests fall — i.e. the slowest 1%. Tail latency matters because one slow dependency can dominate a fan-out request."
      },
      {
        "term": "Stateless service",
        "says": "Holds no session",
        "means": "A service that keeps no client-specific state between requests, so any instance can serve any request and scaling out is trivial."
      },
      {
        "term": "Idempotency key",
        "says": "Dedup token",
        "means": "A client-supplied unique identifier attached to a request so the server can detect and ignore duplicate submissions of the same operation."
      },
      {
        "term": "Write amplification",
        "says": "One write becomes many",
        "means": "When a single logical write triggers multiple physical writes (indexes, replicas, fan-out), increasing load disproportionately."
      },
      {
        "term": "Hotspot",
        "says": "Overloaded key/node",
        "means": "A single key, partition, or node receiving disproportionate traffic, often the limiting factor in an otherwise well-distributed system."
      }
    ],
    "artifacts": [],
    "prereqs": {
